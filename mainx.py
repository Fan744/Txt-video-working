...
bot = Client(
    "bot",
    bot_token=os.environ.get("7593412557:AAGh4AgF3YcelBK6vRtzH70ONerIaGzWt3s"),
    api_id=int(os.environ.get("20924859")),
    api_hash=os.environ.get("918bf88147ce14b28f713973fd239443
")
)
